...
class Game:
    ...
    def roll(self, roll):
        ...
        if self.in_penalty_box[self.current_player]:
            if roll % 2 != 0:
                ...
                print
                "%s is getting out of the penalty box" % self.players[self.current_player]
    ...
    def _ask_question(self):
        ...
        self.pop_questions.pop(0)
        if self._current_category == 'Science': print
        self.science_questions.pop(0)
        if self._current_category == 'Sports': print
        self.sports_questions.pop(0)
        if self._current_category == 'Rock': print
        self.rock_questions.pop(0)
